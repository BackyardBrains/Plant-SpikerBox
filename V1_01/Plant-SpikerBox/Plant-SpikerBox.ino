...
// 
// PB1 - LED - Power ON
// D5 - relay control pin
// D6 - Enable button input
// D7 - LED - Ready indicator
// D13 - AM modulation carier generator pin
//
// Backyard Brains
// Stanislav Mircic
// 6.Jan. 2020.
...
void setup(){ 
  ...
  DDRB |= B00000010;//Set PB1 as output
  PORTB |=  B00000010;//set output to HIGH (Power ON indication LED)
